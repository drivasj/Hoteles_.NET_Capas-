...
function ConfigurarDatos(res,objConfiguracion, objFormulario, objBusqueda) {
    ...
    if (objConfiguracion != undefined) {
        ...
        if (objConfiguracion.nuevo == true) {
            contenido +="<button class='btn btn-outline-secondary  mb-3' onclick='ClickNuevo()'>Nuevo2</button>"
        }
        //Reporte Excel
             ...
             ${objConfiguracion.popup == true ?
              ...
              class="btn btn-primary" 
               onclick='${(objFormulario != undefined &&
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" fill="currentColor" class="bi bi-eyedropper" viewBox="0 0 16 16">
